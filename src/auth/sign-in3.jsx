        ...
        <div className="w-full md:w-1/2 p-6 md:p-8 flex flex-col justify-between animate-fade-in-left">
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
            ...
            <div className="animate-slide-up delay-100">
              <label className="block font-medium mb-1 text-xs md:text-sm  lg:text-[13px] text-gray-700">DHIS2 Facility code</label>
              <input
                type="text"
                placeholder="e.g., Nyabihu district hospital"
                className="w-full border border-gray-300 rounded-lg px-2 py-1 md:px-3 md:py-2 lg:text-[13px] text-gray-400 text-sm md:text-base focus:outline-none focus:ring-2 focus:ring-[#0B2447] focus:border-transparent transition-all duration-300 hover:border-[#0B2447] hover:shadow-md"
              />
            </div>

            {/* Optional field next to Organization Name */}
            <div className="animate-slide-up delay-200">
              <label className="block font-medium mb-1 text-xs md:text-sm lg:text-[13px] text-gray-700">Phone number</label>
              <input
                type="text"
            ...
            <div className="animate-slide-up delay-300">
              <label className="block font-medium mb-1 text-[2px] md:text-sm  lg:text-[13px] text-gray-700">Link to ambulance dispatch</label>
               <input
                type="text"
                placeholder="Enter value"
                className="w-full border border-gray-300 rounded-lg px-2 py-1 md:px-3 md:py-2  lg:text-[13px] text-gray-400  text-sm md:text-base focus:outline-none focus:ring-2 focus:ring-[#0B2447] focus:border-transparent transition-all duration-300 hover:border-[#0B2447] hover:shadow-md"
            ...
            <div className="animate-slide-up delay-400">
              <label className="block font-medium mb-1 text-xs md:text-sm  lg:text-[13px] text-gray-700">Number of ambulances</label>
              <input
                type="text"
            ...
            <div className="md:col-span-2 animate-slide-up delay-700">
              <label className="block font-medium mb-1 text-xs md:text-sm  lg:text-[13px] text-gray-700">Enter Emergency phone number</label>
              <input
                type="text"
                placeholder="e.g., Nyabihu main road near stadium"
                className="w-full border border-gray-300 rounded-lg px-2 py-1 md:px-3 md:py-2 text-sm  text-gray-400 lg:text-[13px] md:text-base focus:outline-none focus:ring-2 focus:ring-[#0B2447] focus:border-transparent transition-all duration-300 hover:border-[#0B2447] hover:shadow-md"
              />
            </div>
          </form>
